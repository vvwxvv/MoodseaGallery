...
export const systemLabels = {
  ...
  // ===========================================
  // SCHEMA FIELD LABELS (batch edit · forms)
  // ===========================================
  cover_img_url_en: "Cover Image URL",          cover_img_url_cn: "封面图片链接",
  coverImageUrl_en: "Cover Image URL",          coverImageUrl_cn: "封面图片链接",
  portrait_image_url_en: "Portrait Image URL",  portrait_image_url_cn: "肖像图片链接",
  duration_en: "Duration",                      duration_cn: "时长",
  credits_en: "Credits",                        credits_cn: "鸣谢",
  special_thanks_en: "Special Thanks",          special_thanks_cn: "特别鸣谢",
  specialThanks_en: "Special Thanks",           specialThanks_cn: "特别鸣谢",
  related_gallery_exhibition_en: "Related Gallery/Exhibition",
  related_gallery_exhibition_cn: "相关画廊/展览",
  relatedGallery_en: "Related Gallery/Exhibition", relatedGallery_cn: "相关画廊/展览",
  related_gallery_artist_en: "Related Artist",  related_gallery_artist_cn: "相关艺术家",
  related_artwork_title_en: "Related Artwork",  related_artwork_title_cn: "相关作品",
  work_value_en: "Work Value",                  work_value_cn: "作品价值",
  workValue_en: "Work Value",                   workValue_cn: "作品价值",
  sold_en: "Sold",                              sold_cn: "已售",
  web_url_en: "Web URL",                        web_url_cn: "网页链接",
  webUrl_en: "Web URL",                         webUrl_cn: "网页链接",
  videoUrl_en: "Video URL",                     videoUrl_cn: "视频链接",
  category_en: "Category",                      category_cn: "分类",
  publisher_en: "Publisher",                    publisher_cn: "出版社",
  isbn_en: "ISBN",                              isbn_cn: "ISBN",
  publication_date_en: "Publication Date",      publication_date_cn: "出版日期",
  name_en: "Name",                              name_cn: "姓名",
  message_en: "Message",                        message_cn: "留言",
  opening_time_en: "Opening Hours",             opening_time_cn: "开放时间",
  gallery_name_en: "Gallery Name",              gallery_name_cn: "画廊名称",
