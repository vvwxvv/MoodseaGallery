// Field labels based on Image Prisma model
export const fieldLabels = {
  // Core fields
  img_url: "Image URL / 图片链接",
  tag_en: "Tag (EN) / 标签 (英文)",
  tag_cn: "Tag (CN) / 标签 (中文)",
  type: "Type / 类型",
...
export const PAGE_TEXT = {
  ...
  controlPanel: {
    ...
    sortByOrderTooltip: { EN: "Sort images by order", CN: "按顺序排序图片" },
    ...
    exportDataTooltip: { EN: "Export image data", CN: "导出图片数据" },
  },
  
  // Field Labels
  fields: {
    imgUrl: { EN: "Image URL", CN: "图片链接" },
  ...
  emptyState: {
    noData: { EN: "No images found", CN: "暂无图片" },
    noMatchingImages: { EN: "No matching images", CN: "没有匹配的图片" },
  },
  ...
  export: {
    ...
    images: { EN: "images", CN: "个图片" },
  },
};

// Action labels
export const actionLabels = {
  create_en: "Create Image",
  create_cn: "创建图片",
  edit_en: "Edit Image",
  edit_cn: "编辑图片",
  delete_en: "Delete Image",
  delete_cn: "删除图片",
  export_en: "Export Images",
  export_cn: "导出图片",
  import_en: "Import Images",
  import_cn: "导入图片",
};
...
export const entityLabels = {
  ...
  images_en: "Images",
  images_cn: "图片",
  untitledImage_en: "Untitled Image",
  untitledImage_cn: "无题图片",
};
...
export const pageLabels = {
  ...
  title_cn: "图片管理",
  description_en: "Manage and organize image content",
  description_cn: "管理和组织图片内容",
};

// UI Text labels
export const uiTextLabels = {
  pageTitle: { en: 'Image Index', cn: '图片索引' },
  tag: { en: 'Tag', cn: '标签' },
  type: { en: 'Type', cn: '类型' },
  tag_source: { en: 'Tag Source', cn: '标签来源' },
  mark: { en: 'Mark', cn: '标记' },
  ...
  noImagesFound: { 
    en: 'No images found matching the criteria', 
    cn: '没有找到符合条件的图片' 
  },
...
export const displayLabels = {
  ...
  emptyMessage: (isCn) => isCn ? '没有可显示的图片' : 'No images to display',
...
export const defaultContentLabels = {
  listTitle: (isCn) => isCn ? "图片列表" : "IMAGE LIST",
  detailsLabel: (isCn) => isCn ? "图片详情" : "IMAGE DETAILS",
  untitled: (isCn) => isCn ? "无题图片" : "Untitled Image",
...
export const deleteDialogLabels = {
  delete_dialog_this_item_en: "this image",
  delete_dialog_this_item_cn: "该图片",
  confirmDeleteImage_en: "Are you sure you want to delete this image?",
  confirmDeleteImage_cn: "确定要删除该图片吗？",
  thisImage_en: "this image",
  thisImage_cn: "该图片",
};
...
export const additionalLabels = {
  ...
  noFeaturedImages_en: "No featured images available",
  noFeaturedImages_cn: "暂无精选图片",
  noMatchingImages_en: "No matching images found",
  noMatchingImages_cn: "没有找到符合条件的图片",
};
...
export const getImageLabel = (key, language = 'en') => {
  ...
  if (imageLabels[labelKey]) {
    return imageLabels[labelKey];
  }
  
  // Fallback to English if Chinese not found
  if (language === 'cn') {
    const englishKey = `${key}_en`;
    if (imageLabels[englishKey]) {
      return imageLabels[englishKey];
    }
  }
...
export const getImageUIText = (key, language = 'en') => {
  if (!key) return '';
