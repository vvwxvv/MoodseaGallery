...
// Configuration
const CONF = {
  collectionName: eventApiConfig.collectionName || '',
  requiredFields: eventApiConfig.requiredFields || [],
  uniqueFields: eventApiConfig.uniqueFields || [],
  validFields: eventApiConfig.validFields || [],
  arrayFields: eventApiConfig.arrayFields || [],
...
const { GET: shellGET, PUT: shellPUT } = createBatchApiHandler(eventApiConfig);
